# Generated by Powerlevel10k configuration wizard on 2023-10-07 at 16:57 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_RIGHT_DELIMITER=' (.venv)'
  ...
  # Show previous command duration only if it's >= 0.5s.
